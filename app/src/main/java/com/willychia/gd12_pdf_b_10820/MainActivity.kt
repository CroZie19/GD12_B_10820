package com.willychia.gd12_pdf_b_10820
...
import com.willychia.gd12_pdf_b_10820.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama:String,umur:String,tlp:String,alamat:String,kampus:String){
        ...
        val file = File(pdfPath,"pdf_10820.pdf")
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.willychia)
